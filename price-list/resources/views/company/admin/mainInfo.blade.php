                ...
                <div class="col col-12 col-md-10">
                    <div class="row">
                        ...
                        <div class="col col-12">
                            <p class="ps-4">
                                На цій сторінці Ви можете змінити основну інформацію про Вашу компанію. 
                                Додайте номер телефону та посилання на свої соціальні мережі, для того, щоб Ваші клієнти могли з Вами зв'язатись. 
                                Додайте інформацію у поле "Опис компанії" для того, щоб розповісти про себе детальніше.
                                Також, змініть основний колір, для того, щоб Ваша сторінка виглядала привабливіше та завантажте логотип магазину. Будь ласка, не обирайте занадто темні відтінки - це погіршить читабельність тексту.<br>
                            </p>
                        </div>
                    </div>
                </div>
