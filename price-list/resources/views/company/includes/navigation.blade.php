<nav class="navbar navbar-expand-md bg-light sticky-top py-2 py-sm-0 mb-5">
    <div class="container-xxl">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-link me-2 me-md-4" href="{{route('company-admin', $company->companyName)}}">
                    <span class="fa-solid fa-screwdriver-wrench"></span> Адміністрування
                </a>
                <a class="nav-link me-2 me-md-4" href="{{route('main-info-admin', $company->companyName)}}">
                    <span class="fa-solid fa-info me-1"></span> Основна інформація
                </a>
                <a class="nav-link me-2 me-md-4" href="{{route('categories-admin', $company->companyName)}}">
                    <span class="fa-solid fa-list me-1"></span> Категорії
                </a>
                <a class="nav-link me-2 me-md-4" href="{{route('items-admin', $company->companyName)}}">
